...
export default function CreateModal({ showModal, setShowModal }: ModalProps) {
                ...
                <form action="#">
                  <div className="grid gap-4 mb-4 sm:grid-cols-2">
                    <div>
                      <label
                        htmlFor="image"
                        className="w-44 h-48 t-4 bg-white shadow-gray rounded-lg relative flex justify-center mb-6"
                      >
                        <div className="w-full h-full flex justify-center items-center">
                          <CameraIcon className="h-12 w-12 text-gray-500" />
                        </div>
                        <img
                          className="absolute t-0 w-full rounded-lg"
                          // src={image}
                          alt=""
                        />
                      </label>
