...
export default function DeleteModal({ showModal, setShowModal }: ModalProps) {
  return (
    <>
      {showModal ? (
        <>
          <div className="justify-center items-center flex overflow-x-hidden bg-black/40 overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-main-light-dark outline-none focus:outline-none">
                {/*header*/}
                <div className="relative p-9 text-center bg-main-light-dark rounded-lg shadow dark:bg-gray-800 sm:p-8">
                  <button
                  ...
                  <div className="flex justify-center items-center space-x-4">
                    <button
                      ...
                      data-modal-toggle="deleteModal"
                      type="button"
                      className="py-2 px-3 text-sm font-medium text-gray-700 bg-gray-100 rounded-lg border border-gray-200 hover:bg-gray-300 focus:ring-4 focus:outline-none focus:ring-primary-300 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600"
                    >
                      Отменить
                    </button>
                    <button
